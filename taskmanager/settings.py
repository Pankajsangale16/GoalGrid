...
# Use SQLite for local development if no PostgreSQL credentials are provided
if not all([os.getenv('POSTGRES_DATABASE'), os.getenv('POSTGRES_USER'), os.getenv('POSTGRES_PASSWORD')]):
    DATABASES['default'] = {
